...
<Cards>
  ...
  <Card title="Decorators" href="/docs/filter/guides/decorators" description="@filterFor for keys a method name cannot spell, and @filterable / @sortable / @searchable on the model's columns." />
