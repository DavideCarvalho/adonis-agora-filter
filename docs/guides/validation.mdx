...
Structural validation guards the *shape*; the [allow-list](/docs/filter/guides/filter-classes) guards *which columns*. By default a disallowed field is dropped silently. Set `throwOnInvalid: true` to reject the request instead:
